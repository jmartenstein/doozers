...
var runCmd = &cobra.Command{
        ...
        Run: func(cmd *cobra.Command, args []string) {
                ...
                if scriptStr != "" {
                        ...
                        useWorktree = persona.UseGitWorktree
                }
                ...
                if dryRun {
                        if useWorktree {
                                ...
                                fmt.Printf("[DRY RUN] Running in-place at '%s'\n", worktreePath)
                        }
                        ...
                        if useWorktree {
                                ...
                                fmt.Println("Outcome sharing would be triggered locally.")
                        }
                        return
                }
                ...
                fmt.Printf("Running script for task %s in %s...\n", taskID, worktreePath)
                ...
                if useWorktree {
                        ...
                        fmt.Println("Agent execution completed successfully. Not sharing outcome as worktree was not used.")
                }
        },
}
...
func init() {
        ...
        runCmd.Flags().BoolVar(&noWorktree, "no-worktree", false, "Do not create a git worktree")
